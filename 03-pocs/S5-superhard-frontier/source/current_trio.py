...
POOL = [
    ("qwen3-235b-think",  "openrouter/qwen/qwen3-235b-a22b-thinking-2507"),
...
def main():
    ...
    json.dump({"n": n, "gpt5.5": {"acc": ga, "usd_task": gc},
              ...
              open(os.path.join(HERE, "currenttrio_results.json"), "w"), indent=1)
    print("wrote currenttrio_results.json | cache:", CACHE.stats())
